...
slowing_time_per_fifteen_meter = 12.5
slowing_time_meters = 15
distance_need_to_swim = distance_meters * time_in_sec_per_meter
slowing_time = math.floor(distance_meters / slowing_time_meters) * slowing_time_per_fifteen_meter
# slowing_time = slowing_time * slowing_time_per_fifteen_meter
